...
public:
    ...
    virtual double Evaluate(FormulaAST::Functor args) const = 0;
...
public:
    ...
    double Evaluate(FormulaAST::Functor args) const override
    {
        double result = 0;
...
public:
    ...
    double Evaluate(FormulaAST::Functor) const override 
    {
        return value_;
    }
...
FormulaAST ParseFormulaAST(const std::string& in_str) {
    ...
    {
        throw FormulaException("Invalid formula: " + in_str);
    }
}
